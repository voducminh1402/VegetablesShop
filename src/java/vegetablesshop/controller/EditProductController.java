...
public class EditProductController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ProductDTO product = new ProductDTO(productID, productName, productImage, productPrice, quantity, description, availableID, categoryID, "");
            ...
            LOGGER.error("Error at EditProductController: " + e.toString());
        }
        finally {
