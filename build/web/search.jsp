                ...
                <ul class="navbar-nav">
                    <li class="dropdown">
                        ...
                        <div class="dropdown-menu">
                            <ul> 
                                <li><a class="dropdown-item nav-link nav_item" href="index.html">Home Page 1</a></li> 
                            ...
                            <ul class="mega-menu d-lg-flex">
                                <li class="mega-menu-col col-lg-3">
                                    <ul> 
                                        ...
                                        <li><a class="dropdown-item nav-link nav_item active" href="search.html">Shop Grid View</a></li>
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="product">
                            ...
                            <div class="product_info">
                                ...
                                <div class="product_action_box">
                                    <ul class="list_none pr_action_btn">
                                    	<li class="add-to-cart"><a href="#"><i class="ti-shopping-cart"></i> Add To Cart</a></li>
                                        <li><a href="#"><i class="ti-heart"></i></a></li>
                                        <li><a href="http://bestwebcreator.com//organiq/demo/shop-quick-view.html" class="popup-ajax"><i class="ti-eye"></i></a></li>
                                    </ul>
                                </div>
