...
<!-- SITE TITLE -->
<title>Success Payment | Organiq - Organic Food HTML Template</title>
<!-- Favicon Icon -->
...
.four_zero_four_bg{
 ...
 background-image: url(https://cdn.dribbble.com/users/1049034/screenshots/4785463/payment-.gif);
    height: 400px;
...
<section class="page_404">
	<div class="container">
		<div class="row">	
		<div class="col-sm-12 ">
		<div class="col-sm-10 center-block col-sm-offset-1  text-center">
		...
		<p>Thank you for supporting my shop!</p>
